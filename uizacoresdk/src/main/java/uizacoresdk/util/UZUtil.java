...
public class UZUtil {
    ...
    public static void resizeLayout(ViewGroup viewGroup, ImageView ivVideoCover, int pixelAdded, int videoW, int videoH, boolean isFreeSize) {
        ...
        if (parentViewGroup != null) {
            parentViewGroup.getLayoutParams().width = FrameLayout.LayoutParams.MATCH_PARENT;
            parentViewGroup.getLayoutParams().height = FrameLayout.LayoutParams.MATCH_PARENT;
